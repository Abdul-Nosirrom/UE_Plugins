...
#include "Editor/K2Node_RootMotionTaskCall.h"
...
UK2Node_RootMotionTaskCall::UK2Node_RootMotionTaskCall(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	ProxyActivateFunctionName = GET_FUNCTION_NAME_CHECKED(URootMotionTask_Base, ReadyForActivation);
}

void UK2Node_RootMotionTaskCall::RegisterSpecializedTaskNodeClass(TSubclassOf<UK2Node_RootMotionTaskCall> NodeClass)
{
	if (NodeClass)
	{
...
bool UK2Node_RootMotionTaskCall::HasDedicatedNodeClass(TSubclassOf<URootMotionTask_Base> TaskClass) 
{
	for (const TWeakObjectPtr<UClass>& NodeClass : NodeClasses)
	{
		if (NodeClass.IsValid())
		{
			UK2Node_RootMotionTaskCall* NodeCDO = NodeClass->GetDefaultObject<UK2Node_RootMotionTaskCall>();
...
bool UK2Node_RootMotionTaskCall::CanCreateUnderSpecifiedSchema(const UEdGraphSchema* DesiredSchema) const
{
	return Super::CanCreateUnderSpecifiedSchema(DesiredSchema);
}

void UK2Node_RootMotionTaskCall::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
	struct GetMenuActions_Utils
	{
		static void SetNodeFunc(UEdGraphNode* NewNode, bool /*bIsTemplateNode*/, TWeakObjectPtr<UFunction> FunctionPtr)
		{
			UK2Node_RootMotionTaskCall* AsyncTaskNode = CastChecked<UK2Node_RootMotionTaskCall>(NewNode);
	...
	ActionRegistrar.RegisterClassFactoryActions<URootMotionTask_Base>( FBlueprintActionDatabaseRegistrar::FMakeFuncSpawnerDelegate::CreateLambda([NodeClass](const UFunction* FactoryFunc)->UBlueprintNodeSpawner*
	{
		UBlueprintNodeSpawner* NodeSpawner = nullptr;
		
		UClass* FuncClass = FactoryFunc->GetOwnerClass();
		if (!UK2Node_RootMotionTaskCall::HasDedicatedNodeClass(FuncClass))
		{
...
struct FK2Node_RootMotionTaskCallHelper
{
...
FName FK2Node_RootMotionTaskCallHelper::WorldContextPinName(TEXT("WorldContextObject"));
FName FK2Node_RootMotionTaskCallHelper::ClassPinName(TEXT("Class"));
FName FK2Node_RootMotionTaskCallHelper::BeginSpawnFuncName(TEXT("BeginSpawningActor"));
FName FK2Node_RootMotionTaskCallHelper::FinishSpawnFuncName(TEXT("FinishSpawningActor"));
FName FK2Node_RootMotionTaskCallHelper::BeginSpawnArrayFuncName(TEXT("BeginSpawningActorArray"));
FName FK2Node_RootMotionTaskCallHelper::FinishSpawnArrayFuncName(TEXT("FinishSpawningActorArray"));
FName FK2Node_RootMotionTaskCallHelper::SpawnedActorPinName(TEXT("SpawnedActor"));

// -------------------------------------------------

void UK2Node_RootMotionTaskCall::ReallocatePinsDuringReconstruction(TArray<UEdGraphPin*>& OldPins)
{
	AllocateDefaultPins();
...
UEdGraphPin* UK2Node_RootMotionTaskCall::GetClassPin(const TArray<UEdGraphPin*>* InPinsToSearch /*= NULL*/) const
{
	...
	{
		if (TestPin && TestPin->PinName == FK2Node_RootMotionTaskCallHelper::ClassPinName)
		{
			Pin = TestPin;
			break;
		}
...
UClass* UK2Node_RootMotionTaskCall::GetClassToSpawn(const TArray<UEdGraphPin*>* InPinsToSearch) const
{
...
void UK2Node_RootMotionTaskCall::CreatePinsForClass(UClass* InClass)
{
...
void UK2Node_RootMotionTaskCall::PinDefaultValueChanged(UEdGraphPin* ChangedPin)
{
	if (ChangedPin->PinName == FK2Node_RootMotionTaskCallHelper::ClassPinName)
	{
		const UEdGraphSchema_K2* K2Schema = GetDefault<UEdGraphSchema_K2>();
...
UEdGraphPin* UK2Node_RootMotionTaskCall::GetResultPin() const
{
...
bool UK2Node_RootMotionTaskCall::IsSpawnVarPin(UEdGraphPin* Pin)
{
	return (Pin->Direction == EEdGraphPinDirection::EGPD_Input &&
			...
			Pin->PinName != FK2Node_RootMotionTaskCallHelper::ClassPinName &&
			Pin->PinName != FK2Node_RootMotionTaskCallHelper::WorldContextPinName);

}

bool UK2Node_RootMotionTaskCall::ValidateActorSpawning(class FKismetCompilerContext& CompilerContext, bool bGenerateErrors)
{
	FName ProxyPrespawnFunctionName = FK2Node_RootMotionTaskCallHelper::BeginSpawnFuncName;
	UFunction* PreSpawnFunction = ProxyFactoryClass ? ProxyFactoryClass->FindFunctionByName(ProxyPrespawnFunctionName) : nullptr;

	FName ProxyPostpawnFunctionName = FK2Node_RootMotionTaskCallHelper::FinishSpawnFuncName;
	UFunction* PostSpawnFunction = ProxyFactoryClass ? ProxyFactoryClass->FindFunctionByName(ProxyPostpawnFunctionName) : nullptr;

	FName ProxyPrespawnArrayFunctionName = FK2Node_RootMotionTaskCallHelper::BeginSpawnArrayFuncName;
	...
	FName ProxyPostpawnArrayFunctionName = FK2Node_RootMotionTaskCallHelper::FinishSpawnArrayFuncName;
...
bool UK2Node_RootMotionTaskCall::ValidateActorArraySpawning(class FKismetCompilerContext& CompilerContext, bool bGenerateErrors)
{
	FName ProxyPrespawnFunctionName = FK2Node_RootMotionTaskCallHelper::BeginSpawnFuncName;
	UFunction* PreSpawnFunction = ProxyFactoryClass ? ProxyFactoryClass->FindFunctionByName(ProxyPrespawnFunctionName) : nullptr;
...
bool UK2Node_RootMotionTaskCall::ConnectSpawnProperties(UClass* ClassToSpawn, const UEdGraphSchema_K2* Schema, class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph, UEdGraphPin*& LastThenPin, UEdGraphPin* SpawnedActorReturnPin)
{
 ...
 *	
 */
void UK2Node_RootMotionTaskCall::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	FName ProxyPrespawnFunctionName = bValidatedActorArraySpawn ? FK2Node_RootMotionTaskCallHelper::BeginSpawnArrayFuncName : FK2Node_RootMotionTaskCallHelper::BeginSpawnFuncName;
	UFunction* PreSpawnFunction = ProxyFactoryClass ? ProxyFactoryClass->FindFunctionByName(ProxyPrespawnFunctionName) : nullptr;

	FName ProxyPostpawnFunctionName = bValidatedActorArraySpawn ? FK2Node_RootMotionTaskCallHelper::FinishSpawnArrayFuncName : FK2Node_RootMotionTaskCallHelper::FinishSpawnFuncName;
	UFunction* PostSpawnFunction = ProxyFactoryClass ? ProxyFactoryClass->FindFunctionByName(ProxyPostpawnFunctionName) : nullptr;
	...
	UEdGraphPin* SpawnedActorReturnPin = CallPrespawnProxyObjectNode->FindPinChecked(FK2Node_RootMotionTaskCallHelper::SpawnedActorPinName);
