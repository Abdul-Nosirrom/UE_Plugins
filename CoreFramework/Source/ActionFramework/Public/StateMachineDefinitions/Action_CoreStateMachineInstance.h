...
#include "Action_CoreStateMachineInstance.generated.h"


UCLASS(Blueprintable, BlueprintType, ClassGroup = ActionManager, hideCategories = (SMStateInstance, Display, Color), meta = (DisplayName = "Core State Machine", ShortTooltip="Base State Machine Class For Creating Gameplay Actions"))
class ACTIONFRAMEWORK_API UAction_CoreStateMachineInstance : public USMStateMachineInstance, public IActionStateFlow
{
	GENERATED_BODY()
	
public:
	UAction_CoreStateMachineInstance();
