...
#include "EngineWindow_PropertyInspector.h"
...
//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::Initialize()
{
    bHasMenu = true;

    Config = GetConfig<UImGuiEngineConfig_PropertyInspector>();
}

//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::RenderHelp()
{
    ImGui::Text(
...
//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::SetInspectedObject(UObject* Value)
{
...
//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::AddFavorite(UObject* Object)
{
...
//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::AddFavorite(UObject* Object, FImGuiEngineInspectorApplyFunction ApplyFunction)
{
    Favorite& Favorite = Favorites.AddDefaulted_GetRef();
    Favorite.Object = Object;
...
//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::RenderContent()
{
    RenderMenu();
    ...
    const FImGuiEngineInspectorApplyFunction ApplyFunction = FindObjectApplyFunction(InspectedObject.Get());
...
//--------------------------------------------------------------------------------------------------------------------------
FImGuiEngineInspectorApplyFunction FEngineWindow_PropertyInspector::FindObjectApplyFunction(const UObject* Object) const
{
...
//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::RenderMenu()
{
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        const ImVec2 Pos = ImGui::GetCursorScreenPos();
        {
            ...
            if (ImGui::Button(InspectedObjectName.Get(), ImVec2(UImGuiHelperWidgets::GetFontWidth() * 20, 0)))
            {
        ...
        {
            ImGui::BeginChild("Popup", ImVec2(UImGuiHelperWidgets::GetFontWidth() * 30, UImGuiHelperWidgets::GetFontWidth() * 40), false);
        ...
        // Search
        //-----------------------------------
        UImGuiHelperWidgets::SearchBar(Filter, -UImGuiHelperWidgets::GetFontWidth() * 9);
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderInspector()
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderBegin()
{
    UImGuiHelperWidgets::PushStyleCompact();

    ImGuiTableFlags TableFlags = 0;//ImGuiTableFlags_Resizable;
...
//--------------------------------------------------------------------------------------------------------------------------
void FEngineWindow_PropertyInspector::RenderEnd()
{
    ImGui::EndTable();
...
//--------------------------------------------------------------------------------------------------------------------------
FString FEngineWindow_PropertyInspector::GetPropertyName(const FProperty& Property)
{
#if WITH_EDITORONLY_DATA
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderPropertyList(TArray<const FProperty*>& Properties, uint8* PointerToValue)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderProperty(const FProperty* Property, uint8* PointerToValue, int IndexInArray)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderBool(const FBoolProperty* BoolProperty, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderByte(const FByteProperty* ByteProperty, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderInt8(const FInt8Property* Int8Property, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderInt(const FIntProperty* IntProperty, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderInt64(const FInt64Property* Int64Property, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderUInt32(const FUInt32Property* UInt32Property, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderFloat(const FFloatProperty* FloatProperty, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderDouble(const FDoubleProperty* DoubleProperty, uint8* PointerToValue)
{
    bool HasChanged = false;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderEnum(const FEnumProperty* EnumProperty, uint8* PointerToValue)
{
    return UImGuiHelperWidgets::ComboboxEnum("##Enum", EnumProperty, PointerToValue);
}

//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderString(const FStrProperty* StrProperty, uint8* PointerToValue)
{
    FString Text;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderName(const FNameProperty* NameProperty, uint8* PointerToValue)
{
    FString NameValue;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderText(const FTextProperty* TextProperty, uint8* PointerToValue)
{
    FString Text;
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderObject(UObject* Object, bool ShowChildren)
{
    if (Object == nullptr)
    {
        ImGui::BeginDisabled();
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderStruct(const FStructProperty* StructProperty, uint8* PointerToValue, bool ShowChildren)
{
    ImGui::BeginDisabled();
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderClass(const FClassProperty* ClassProperty)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderInterface(const FInterfaceProperty* InterfaceProperty)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::RenderArray(const FArrayProperty* ArrayProperty, uint8* PointerToValue, bool ShowChildren)
{
...
//--------------------------------------------------------------------------------------------------------------------------
bool FEngineWindow_PropertyInspector::HasPropertyAnyChildren(const FProperty* Property, uint8* PointerToValue)
{
