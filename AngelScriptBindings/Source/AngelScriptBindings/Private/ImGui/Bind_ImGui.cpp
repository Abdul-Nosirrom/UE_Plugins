...
FAngelscriptBinds::FBind Bind_ImGuiTreeNodeFlags(FAngelscriptBinds::EOrder::Early, []
{
	...
	IMGUI_ENUM_VALUE(ImGuiTreeNodeFlags, AllowOverlap,);
...
FAngelscriptBinds::FBind Bind_ImGuiSelectableFlags(FAngelscriptBinds::EOrder::Early, []
{
	...
	IMGUI_ENUM_VALUE(ImGuiSelectableFlags, NoAutoClosePopups,);
	...
	IMGUI_ENUM_VALUE(ImGuiSelectableFlags, AllowOverlap,);
});
...
FAngelscriptBinds::FBind Bind_ImGuiDragDropFlags(FAngelscriptBinds::EOrder::Normal, []
{
	...
	IMGUI_ENUM_VALUE(ImGuiDragDropFlags, PayloadAutoExpire,);
...
FAngelscriptBinds::FBind Bind_ImGuiKey(FAngelscriptBinds::EOrder::Normal, []
{
	...
	// Manually do these cuz they have different signatures
	static ImGuiKey ModNone = ImGuiMod_None;
	static ImGuiKey ModCtrl = ImGuiMod_Ctrl;
	static ImGuiKey ModShift = ImGuiMod_Shift;
	static ImGuiKey ModAlt = ImGuiMod_Alt;
	static ImGuiKey ModSuper = ImGuiMod_Super;

	FAngelscriptBinds::BindGlobalVariable("EImGuiKey ModNone", &ModNone);
	FAngelscriptBinds::BindGlobalVariable("EImGuiKey ModCtrl", &ModCtrl);
	FAngelscriptBinds::BindGlobalVariable("EImGuiKey ModShift", &ModShift);
	FAngelscriptBinds::BindGlobalVariable("EImGuiKey ModAlt", &ModAlt);
	FAngelscriptBinds::BindGlobalVariable("EImGuiKey ModSuper", &ModSuper);
});
...
FAngelscriptBinds::FBind Bind_ImGuiCol(FAngelscriptBinds::EOrder::Normal, []
{
	...
	IMGUI_ENUM_VALUE(ImGuiCol, TabSelected,);
	IMGUI_ENUM_VALUE(ImGuiCol, TabDimmed,);
	IMGUI_ENUM_VALUE(ImGuiCol, TabDimmedSelected,);
...
FAngelscriptBinds::FBind Bind_ImGui_Widget_Utilities(FAngelscriptBinds::EOrder::Late, []
{
	...
	FAngelscriptBinds::BindGlobalFunction("void SetNextItemAllowOverlap()",
	[]() -> void {
